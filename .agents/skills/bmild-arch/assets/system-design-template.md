...
Finalization sweep: every applicable structural dimension is decided (link its section), deferred with a reason, or an explicit open question — including the operational envelope. A silently absent dimension is a finding; a dimension that does not apply is marked not applicable with its reason.

- Boundaries & ownership: Decided §<n> | Deferred — <reason> | Open question — <question> | Not applicable — <reason>
- Data & persistence: ...
- Integration / API: ...
- Service contracts: ...
- Failure & consistency: ...

...
**Step 2 — Begin.** Capture the topic and any constraints, then launch into the first technique without ceremony. If the topic is unclear, ask one question.
...
- [ ] Step 2: Select or recommend a technique from `./resources/brain-methods.yaml`.
...
**Techniques:** All techniques are loaded on-demand from `./resources/brain-methods.yaml`. Do not invent technique names or use techniques from memory — read the file.
...
Follow the instructions in [resources/step-01-setup.md](resources/step-01-setup.md).

...
Natural close phrases that bring the session here: `done`, `exit`, `close session`, `that's enough`, `wrap up`.

The `[E]` option at the end of each debate round also routes here.

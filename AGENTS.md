...
4. **Context-Aware Personas**:
   ...
   UX and Arch hydrate PM artifacts first, treat explicit `product-brief.md` and `prd.md` requirements as settled inputs, then formulate domain hypotheses and elicit only remaining UX or architecture decisions.

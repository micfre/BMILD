...
- [Using scripts in skills](<https://agentskills.io/skill-creation/using-scripts.md> and `docs/agent-skills-using-scripts.md`): How to run commands and bundle executable scripts in your skills.
- [Specification](<https://agentskills.io/specification.md> and `docs/agent-skills-specification.md`): The complete format specification for Agent Skills.

...
4. **Scribe** the exact settled patch into the target artifact; update its `updated` frontmatter date. Add a one-line note at the scribed location carrying the attribution (§4).

...
- **Determinism:** same input yields the same output — see `TBD inline` and `[Actor]` notes.

<!--
TBD TODO FIXME XXX and [capability] and [Description] live inside a comment
-->

```text
TBD TODO FIXME XXX [Actor] [capability]
```
